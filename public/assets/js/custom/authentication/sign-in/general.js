...
e.addEventListener("click", function(n){
    ...
    i.validate().then(function(status){
        if (status === "Valid") {
            ...
            Swal.fire({
                text: "Pastikan username dan password terisi.",
                icon: "error",
