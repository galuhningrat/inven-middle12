...
Route::middleware(['auth', 'prevent-back-history'])->group(function () {
    ...
    Route::put('/mahasiswa/{nim}/akademik', [MahasiswaController::class, 'updateAkademik'])->name('mahasiswa.akademik.update')->middleware('role:admin');
    ...
    Route::post('/mahasiswa/{nim}/pembayaran', [MahasiswaController::class, 'storePembayaran'])->name('mahasiswa.pembayaran.store')->middleware('role:admin,keuangan');
    Route::put('/mahasiswa/{nim}/pembayaran/{id}', [MahasiswaController::class, 'updatePembayaran'])->name('mahasiswa.pembayaran.update')->middleware('role:admin,keuangan');
    Route::delete('/mahasiswa/{nim}/pembayaran/{id}', [MahasiswaController::class, 'destroyPembayaran'])->name('mahasiswa.pembayaran.destroy')->middleware('role:admin,keuangan');
    Route::get('/mahasiswa/{nim}/kelengkapan-dokumen', [MahasiswaController::class, 'kelengkapanDokumen'])->name('mahasiswa.kelengkapan-dokumen');
    Route::post('/mahasiswa/{nim}/kelengkapan-dokumen/upload', [MahasiswaController::class, 'uploadKelengkapanDokumen'])->name('mahasiswa.kelengkapan-dokumen.upload');
    Route::post('/mahasiswa/{nim}/kelengkapan-dokumen/toggle', [MahasiswaController::class, 'toggleHardfileStatus'])->name('mahasiswa.kelengkapan-dokumen.toggle');
    Route::delete('/mahasiswa/{nim}/kelengkapan-dokumen/{jenis}', [MahasiswaController::class, 'deleteKelengkapanDokumen'])->name('mahasiswa.kelengkapan-dokumen.delete');
    ...
    // ============================================================
    // Data Mata Kuliah
    // PENTING: route dengan segmen statis (all-data, store) harus
