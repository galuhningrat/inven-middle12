    ...
    <div id="kt_content_container" class="container-fluid">
        ...
        <div class="row g-4 mb-6">
            <div class="col-sm-6 col-xl-3">
                <div class="card h-100">
                    <div class="card-body d-flex align-items-center p-5">
                        <div class="d-flex flex-center w-50px h-50px rounded-circle bg-light-primary me-4 flex-shrink-0">
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="card h-100">
                    <div class="card-body d-flex align-items-center p-5">
                        <div class="d-flex flex-center w-50px h-50px rounded-circle bg-light-success me-4 flex-shrink-0">
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="card h-100">
                    <div class="card-body d-flex align-items-center p-5">
                        <div class="d-flex flex-center w-50px h-50px rounded-circle bg-light-warning me-4 flex-shrink-0">
        ...
        <div class="card">
            <div class="card-header border-0 pt-5 pb-0">
                <ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-6 fw-bold"
                    id="fakultasTabs" role="tablist">
                    @foreach($fakultas as $fi => $fak)
                    <li class="nav-item" role="presentation">
                        <button class="nav-link text-active-primary pb-4 {{ $fi === 0 ? 'active' : '' }}"
                            data-bs-toggle="tab"
                            data-bs-target="#fak-pane-{{ $fak->id }}"
                            type="button" role="tab">
                            <i class="bi bi-building me-2"></i>
                            {{ $fak->nama_fakultas }}
                            <span class="badge badge-light-primary ms-2">{{ $fak->prodi->count() }} Prodi</span>
                        </button>
                    </li>
                    @endforeach
                </ul>
                        ...
                        <div class="d-flex gap-5">
                            ...
                            <div class="flex-shrink-0" style="width:230px">
                                <div class="nav flex-column nav-pills gap-2"
                                    ...
                                    <button class="nav-link btn btn-flex btn-active-light-primary text-start px-4 py-3
                                        {{ $pi === 0 ? 'active' : '' }}"
                                        data-bs-toggle="pill"
                                        data-bs-target="#prodi-pane-{{ $prodi->id }}"
                                        type="button" role="tab">
                                        <span class="d-flex flex-column align-items-start w-100">
                                            <span class="fw-bold fs-7 text-gray-800">{{ $prodi->nama_prodi }}</span>
                                    ...
                                    <div class="tab-pane fade {{ $pi === 0 ? 'show active' : '' }}"
                                        ...
                                        <div class="d-flex align-items-center mb-5 pb-4 border-bottom">
                                            <div class="flex-grow-1">
                                                <h4 class="fw-bold text-gray-800 mb-1">{{ $prodi->nama_prodi }}</h4>
                                                <div class="d-flex gap-2">
                                                    @if($prodi->kode_prodi)
                                                        <span class="badge badge-light-info">{{ $prodi->kode_prodi }}</span>
                                                    @endif
                                                    @if($prodi->jenjang)
                                                        <span class="badge badge-light-success">{{ strtoupper($prodi->jenjang) }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                        ...
                                        @if($bySemester->isEmpty())
                                            <div class="text-center py-10 text-muted">
                                                <i class="bi bi-file-earmark-x fs-3x text-gray-300 d-block mb-3"></i>
                                        ...
                                        <div class="accordion accordion-icon-collapse"
                                            ...
                                            <div class="accordion-item mb-3 border rounded">
                                                <h2 class="accordion-header" id="hd-{{ $semId }}">
                                                    <button class="accordion-button collapsed fw-semibold fs-6 py-4 px-5 bg-light-primary rounded"
                                                        type="button"
                                                        data-bs-toggle="collapse"
                                                        data-bs-target="#col-{{ $semId }}"
                                                        aria-expanded="false">
                                                        <div class="d-flex align-items-center w-100 me-3">
                                                            <span class="badge badge-primary me-3 px-3 flex-shrink-0">
                                                                Sem. {{ $semester }}
                                                            </span>
                                                            ...
                                                            <span class="ms-auto d-flex gap-2">
                                                                <span class="badge badge-light-primary">
                                                                    {{ $mappings->count() }} Mata Kuliah
                                                                </span>
                                                                <span class="badge badge-light-success">
                                                                    {{ $mappings->sum(fn($mp) => $mp->matkul?->bobot ?? 0) }} SKS
                                                                </span>
                                                            </span>
                                                        </div>
                                                    </button>
                                                ...
                                                <div id="col-{{ $semId }}"
                                                    ...
                                                    <div class="accordion-body p-0">
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered table-striped table-sm align-middle fs-6 gy-2 w-100 mb-0">
                                                                <thead class="bg-gray-100 text-gray-800 border-bottom border-gray-300">
                                                                    <tr class="fw-bold text-uppercase fs-8">
                                                                        <th class="ps-4 py-3" style="width:110px">Kode MK</th>
                                                                        <th class="py-3">Nama Mata Kuliah</th>
                                                                        <th class="text-center py-3" style="width:65px">SKS</th>
                                                                        <th class="text-center py-3" style="width:90px">Jenis</th>
                                                                        <th class="py-3" style="width:175px">Dosen Pengampu</th>
                                                                        <th class="py-3" style="width:110px">Berlaku</th>
                                                                ...
                                                                <tbody>
                                                                    @foreach($mappings->sortBy(fn($mp) => $mp->matkul?->kode_mk) as $mapping)
                                                                        ...
                                                                        @if(!$mk) @continue @endif
                                                                        <tr>
                                                                            <td class="ps-4">
                                                                                <span class="badge badge-light fw-bold text-dark font-monospace">
                                                                                    {{ $mk->kode_mk }}
                                                                                </span>
                                                                            </td>
                                                                            <td class="fw-semibold text-gray-800">{{ $mk->nama_mk }}</td>
                                                                            ...
                                                                            <td class="text-center">
                                                                                ...
                                                                                @endphp
                                                                                <span class="badge badge-light-{{ $jc }} fw-semibold">
                                                                                ...
                                                                                @if($mk->dosen && $mk->dosen->user)
                                                                                    <div class="d-flex align-items-center gap-2">
                                                                                        <div class="symbol symbol-25px flex-shrink-0">
                                                                                            <span class="symbol-label bg-light-success fs-9 fw-bold text-success">
                                                                                                {{ strtoupper(substr($mk->dosen->user->nama, 0, 1)) }}
                                                                                            </span>
                                                                                        </div>
                                                                                        <span class="text-truncate fs-8" style="max-width:125px">
                                                                                            {{ $mk->dosen->user->nama }}
                                                                                        </span>
                                                                                    </div>
                                                                                @else
                                                                            ...
                                                                            <td>
                                                                                @if($mk->prodiMappings->count() > 1)
                                                                                    <span class="badge badge-light-info fs-9"
                                                                                        ...
                                                                                        {{ $mk->prodiMappings->count() }} Prodi
                                                                                    </span>
                                                                                @else
                                                                                    <span class="badge badge-light fs-9">Prodi ini</span>
                                                                                @endif
                                                                            </td>
                                                                            <td class="text-center">
                                                                                {{-- DETAIL --}}
                                                                                <button type="button"
                                                                                    ...
                                                                                    data-bs-target="#modalDetailMatkulIdx{{ $mk->id }}">
                                                                                ...
                                                                                <button type="button"
                                                                                    ...
                                                                                    title="Hapus"
                                                                                    data-bs-toggle="modal"
                                                                                    data-bs-target="#modalDeleteMatkulIdx{{ $mk->id }}">
                                                                        ...
                                                                        {{-- Modal Detail --}}
                                                                        @php
                                                                            // Rename variable $m agar tidak konflik di dalam loop ganda
                                                                            $m = $mk;
                                                                        @endphp
                                                                        <div class="modal fade"
                                                                            id="modalDetailMatkulIdx{{ $mk->id }}"
                                                                            ...
                                                                            <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                                                                                <div class="modal-content">
                                                                                        ...
                                                                                        <div class="d-flex align-items-center gap-3">
                                                                                            <div class="symbol symbol-50px symbol-circle bg-primary">
                                                                                                <span class="symbol-label fw-bolder text-white fs-5">
                                                                                                    {{ strtoupper(substr($mk->kode_mk, 0, 2)) }}
                                                                                                </span>
                                                                                            </div>
                                                                                            <div>
                                                                                                <div class="d-flex align-items-center gap-2 mb-1">
                                                                                                    <span class="badge badge-light-dark fw-bold fs-8">{{ $mk->kode_mk }}</span>
                                                                                                    @php
                                                                                                        $jMap = ['wajib'=>['label'=>'Wajib','class'=>'badge-primary'],'pilihan'=>['label'=>'Pilihan','class'=>'badge-warning'],'umum'=>['label'=>'Umum','class'=>'badge-info']];
                                                                                                        $jInfo = $jMap[$mk->jenis] ?? ['label'=>ucfirst($mk->jenis),'class'=>'badge-secondary'];
                                                                                                    @endphp
                                                                                                    <span class="badge {{ $jInfo['class'] }} fs-9">{{ $jInfo['label'] }}</span>
                                                                                                    <span class="badge badge-dark fs-9">{{ $mk->bobot }} SKS</span>
                                                                                                </div>
                                                                                                <h5 class="modal-title fw-bolder text-dark mb-0 fs-5">{{ $mk->nama_mk }}</h5>
                                                                                            </div>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="modal-body pt-6 pb-4">
                                                                                        {{-- Dosen --}}
                                                                                        <div class="mb-5">
                                                                                            <div class="text-muted fs-8 fw-semibold text-uppercase mb-2">Dosen Pengampu</div>
                                                                                            <div class="d-flex align-items-center gap-3 p-4 bg-light rounded-2">
                                                                                                <div class="symbol symbol-40px symbol-circle bg-primary">
                                                                                                    <span class="symbol-label fw-bold text-white">
                                                                                                        {{ strtoupper(substr($mk->dosen->user->nama ?? '-', 0, 1)) }}
                                                                                                    </span>
                                                                                                </div>
                                                                                                <div>
                                                                                                    <div class="fw-bolder text-dark">{{ $mk->dosen->user->nama ?? '-' }}</div>
                                                                                                    @if($mk->dosen && $mk->dosen->nip)
                                                                                                        <div class="text-muted fs-8">NIP {{ $mk->dosen->nip }}</div>
                                                                                                    @endif
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                        {{-- Mapping --}}
                                                                                        <div class="text-muted fs-8 fw-semibold text-uppercase mb-2">Mapping Prodi & Semester</div>
                                                                                        @if($mk->prodiMappings->isEmpty())
                                                                                            <div class="text-center py-4 bg-light rounded-2 text-muted fs-7">
                                                                                                Belum ada mapping prodi
                                                                                            </div>
                                                                                        @else
                                                                                        <table class="table table-bordered table-sm align-middle fs-7 mb-0">
                                                                                            <thead class="bg-gray-50">
                                                                                                <tr class="fw-bold text-muted fs-9 text-uppercase">
                                                                                                    <th class="ps-4">#</th>
                                                                                                    <th>Program Studi</th>
                                                                                            ...
                                                                                            <tbody>
                                                                                                @foreach($mk->prodiMappings as $idx => $mp)
                                                                                                <tr>
                                                                                                    <td class="ps-4 text-muted">{{ $idx+1 }}</td>
                                                                                                    <td class="fw-semibold">{{ $mp->prodi->nama_prodi ?? '-' }}</td>
                                                                                                    <td class="text-center"><span class="badge badge-light-info fs-9">{{ $mp->prodi->kode_prodi ?? '?' }}</span></td>
                                                                                                    <td class="text-center"><span class="badge badge-light-success fw-bold fs-9">Sem. {{ $mp->semester }}</span></td>
                                                                                                </tr>
                                                                                                @endforeach
                                                                                            </tbody>
                                                                                        </table>
                                                                                    ...
                                                                                    <div class="modal-footer border-0 justify-content-between">
                                                                                        ...
                                                                                        @can('kurikulum-update')
                                                                                        <button type="button" class="btn btn-success btn-open-edit-matkul"
        ...
        {{-- Modal Tambah (dari halaman ini juga bisa tambah) --}}
...
$(document).ready(function () {
    ...
    // Tooltip untuk badge "N Prodi"
    $('[title]').tooltip({ trigger: 'hover' });

    // Tombol tambah di toolbar (opsional)
    // Jika ada tombol tambah di toolbar, uncomment dan sesuaikan route
    // document.getElementById('btn-tambah-kurikulum')?.addEventListener('click', function () {
    //     new bootstrap.Modal(document.getElementById('modalTambahMatkul')).show();
    // });
